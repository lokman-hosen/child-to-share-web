...
const DonorWisherDashboard = ({availableDonationCount, donatedDonationCount,activeWishCount,fulfilledWishCount,wishRequests}) => {
    return (
...
export default DonorWisherDashboard;
