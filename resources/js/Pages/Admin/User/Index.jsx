...
import {faGridHorizontal, faPlus, faStar, faTable} from "@fortawesome/free-solid-svg-icons";
                                                ...
                                                <div className="p-4">
                                                    ...
                                                    <div className="space-y-2 mb-4">
                                                        <div className="flex items-center text-sm text-gray-600">
                                                            ...
                                                            <span className="capitalize">{user.age_range}</span>
                                                        </div>
                                                        <div className="flex items-center text-sm text-gray-600">
                                                                ...
                                                                <div className="flex items-center justify-between">
                                                                    <div className="flex items-center">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <p className="text-sm text-gray-500">dfgdfgf</p>
                                                    ...
                                                    <div key={user.id} className="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden group">
                                                        ...
                                                        <div className="p-5">
                                                            ...
                                                            <div className="space-y-2 mb-4">
                                                                <div className="flex items-center text-sm text-gray-600">
                                                                    <span className="font-medium mr-2">Age Range:</span>
                                                                    <span className="capitalize">dasd</span>
                                                                </div>
                                                                <div className="flex items-center text-sm text-gray-600">
                                                                    <span className="font-medium mr-2">Wisher:</span>
                                                                    <span>asdasd</span>
