    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="px-10 py-8">
                <h1 className="text-2xl font-bold text-gray-900 mb-6">Wishes List</h1>
                        ...
                        <div className="overflow-x-auto bg-white shadow rounded-lg">
                            <table className="wish-table w-full">
                                ...
                                <tr>
                                    ...
                                    <th className="text-left p-3 border border-gray-300">Wisher Name</th>
                                    <th className="text-left p-3 border border-gray-300">Wished At</th>
