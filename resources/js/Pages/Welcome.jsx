                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex items-center">
                            ...
                            <div className="hidden md:ml-6 md:flex md:space-x-8">
                                <a href="index.html"
                                   className="nav-item active text-gray-500 hover:text-gray-700 inline-flex items-center px-1 pt-1 text-sm font-medium">Home</a>
                                <a href="#how-it-works"
                                   className="text-gray-500 hover:text-gray-700 inline-flex items-center px-1 pt-1 text-sm font-medium">How
                                    It Works</a>
                                <a href="wish-new.html"
                                   className="text-gray-500 hover:text-gray-700 inline-flex items-center px-1 pt-1 text-sm font-medium">Wishes</a>
